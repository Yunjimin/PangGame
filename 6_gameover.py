# 모든 공을 없애면 게임 종료, 캐릭터는 공에 닿으면 게임 종료, 시간제한 99초 초과시 게임 종료
...
image_path = os.path.join(current_path, "images") # images 폴더 위치 ㅏㄴ환
...
# 공 위치 정의
    for ball_idx, ball_val in enumerate(balls):
        ...
        #가로벽에 닿았을 때 공 이동 위치 변경(공 튀겨나오는 효과)
